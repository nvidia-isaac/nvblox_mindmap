...
html_theme_options = {
    ...
    "footer_links": {},
    "github_url": "https://github.com/nvidia-isaac/nvblox_mindmap",
}
...
linkcheck_ignore = [r"https://huggingface.co*", r"https://github.com/nvidia-isaac/nvblox_mindmap*"]
...
mindmap_docs_config = {
    ...
    "external_git_url": "git@github.com:nvidia-isaac/nvblox_mindmap.git",
    "internal_code_link_base_url": "https://gitlab-master.nvidia.com/nvblox/mindmap/-/tree/main",
    "external_code_link_base_url": "https://github.com/nvidia-isaac/nvblox_mindmap/tree/public",
}
