...
@configclass
class DrillInBoxGR1MimicEnvCfg(DrillInBoxGR1EnvCfg, MimicEnvCfg):
    ...
    def __post_init__(self):
        ...
        # EEF on target side (arm needs to place the power drill in the open box)
        subtask_configs = []
        subtask_configs.append(
            SubTaskConfig(
                # Each subtask involves manipulation with respect to a single object frame.
                object_ref="power_drill",
