...
class DrillInBoxGR1MimicEnv(ManagerBasedRLMimicEnv):
...
class DrillInBoxGR1LeftMimicEnv(DrillInBoxGR1MimicEnv):
    def __init__(self, **kwargs):
        super().__init__(target_side=TargetSide.LEFT, **kwargs)


class DrillInBoxGR1RightMimicEnv(DrillInBoxGR1MimicEnv):
    def __init__(self, **kwargs):
